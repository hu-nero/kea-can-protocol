...
typedef enum 
{
  Action_Read_Data              = 0x90,
  Action_Write_RegData          = 0x10,
  Action_Read_Data2             = 0xA0,
  Action_Write_RegData2         = 0x20,
  Action_Read_Data3             = 0xB0,
  Action_Write_RegData3         = 0x30
} RA4803_Action;
