...
can_protocol_task_single_ch_read(uint8_t Ch, uint32_t *Value)
{
    ...
    switch (Ch)
    {
        ...
        case 16:
            {
                res = hal_gpio_read_pin(DUT_CH16_PORT, DUT_CH16_PIN, Value);
            }
            break;
        case 17:
            {
                res = hal_gpio_read_pin(DUT_CH17_PORT, DUT_CH17_PIN, Value);
            }
            break;
        case 18:
            {
                res = hal_gpio_read_pin(DUT_CH18_PORT, DUT_CH18_PIN, Value);
            }
            break;
        case 19:
            {
                res = hal_gpio_read_pin(DUT_CH19_PORT, DUT_CH19_PIN, Value);
            }
            break;
        case 20:
            {
                res = hal_gpio_read_pin(DUT_CH20_PORT, DUT_CH20_PIN, Value);
            }
            break;
        case 21:
            {
                res = hal_gpio_read_pin(DUT_CH21_PORT, DUT_CH21_PIN, Value);
            }
            break;
        case 22:
            {
                res = hal_gpio_read_pin(DUT_CH22_PORT, DUT_CH22_PIN, Value);
            }
            break;
        case 23:
            {
                res = hal_gpio_read_pin(DUT_CH23_PORT, DUT_CH23_PIN, Value);
            }
            break;
        default:break;
    }
